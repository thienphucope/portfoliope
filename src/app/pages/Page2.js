/* Cover Component: Adjusted for mobile scrolling, flexible layout, and full background/mask coverage */
"use client";
    ...
    <section id="cover" className="w-full h-screen bg-[var(--background)] snap-start font-serif box-border relative sm:overflow-y-auto sm:no-scrollbar">
      ...
      <div ref={wrapperRef} className="w-[75%] h-[80%] sm:h-auto sm:min-h-[95%] sm:top-4 md:top-1/2 md:-translate-y-1/2 left-1/2 -translate-x-1/2 flex flex-col items-center justify-center absolute">
        ...
        <div ref={contentRef} className="relative z-10 w-full h-full sm:h-auto bg-[url('/newspaper.jpg')] bg-no-repeat bg-center bg-cover flex flex-col justify-start items-center pt-2 pb-4 px-4 md:pt-4 md:pb-2 md:px-8 text-gray-800 shadow-inner rounded-md overflow-y-auto no-scrollbar">
          ...
          {/* Content */}
          <h1 className="text-4xl md:text-[5vw] lg:text-6xl font-extrabold leading-tight tracking-tight text-center font-chomsky relative z-10">
            THE OBSESSIVE PULSE
          </h1>

          <div className="w-full flex items-center justify-center gap-4 my-1 relative z-10">
          ...
          <div className="w-full flex flex-col md:flex-row gap-8 min-h-fit relative z-10">
            <div className="w-full md:w-1/2 flex flex-col min-h-fit">
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-center tracking-tight font-chomsky">
              ...
              <div className="flex flex-col md:flex-row gap-6 min-h-fit">
                <div className="w-full md:w-1/2 text-sm md:text-base leading-normal text-justify">
                  <div className="mb-4">
                    ...
                    errors in human actions. In the city&apos;s chaos, Ope turns raw data
              ...
              <div className="flex flex-col md:flex-row gap-6 min-h-fit">
                <div className="w-full md:w-1/2 text-sm md:text-base leading-normal text-justify">
                  <div className="mb-2">
                    ...
                    training a beastly neural net. He thought it&apos;d be a quick debug
                  ...
                  <div className="w-full h-auto">
                    <img
                      src="/torch.png"
                      alt="Placeholder"
                      className="w-[75%] mx-auto mt-1 mb-2 object-cover"
                    />
                  </div>
                  <div className="pb-0">
                ...
                <div className="w-full md:w-1/2 text-sm md:text-base leading-normal text-justify mb-4">
                  ...
                  an alley. Halfway through epoch 27, PyTorch&apos;s autograd started
                  ...
                  brighter than a supernova. Ope stared, and laughed, “Well, that&apos;s
                  the hottest show in town tonight!” His PyTorch adventure ended
                  with a fried chip and a lesson: never underestimate a GPU&apos;s flair
                  for dramatic exits.
                </div>
              </div>
            </div>
      ...
      {/* More clues button: Bottom-right, scrolls right to Gallery */}
      <div className="absolute bottom-8 right-0 flex justify-center items-center gap-2 pr-5 pb-8 z-30">
        <div onClick={scrollToRight} className="flex items-center gap-2 text-amber-100 text-lg md:text-2xl font-medium hover:text-amber-300 transition-colors cursor-pointer">
          <span>more clues</span><FaArrowRight/>
        </div>
      </div>
    </section>
  );
