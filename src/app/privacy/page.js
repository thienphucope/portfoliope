...
export default async function PrivacyPage() {
  ...
  return (
    <>
      ...
      <Header />
      <MomentumScroll />
      <div className="min-h-screen bg-[#121212] py-30 px-6 md:px-20" style={{ fontFamily: 'var(--font-body)' }}>
        <div className="max-w-4xl mx-auto">
          <article className="relative z-50 prose prose-invert prose-lg md:prose-xl max-w-none
            prose-headings:font-fredericka prose-headings:text-[var(--theme)]
            prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-justify
            prose-strong:text-[var(--theme)]
            prose-li:text-gray-300
            prose-code:text-[var(--theme)]">
